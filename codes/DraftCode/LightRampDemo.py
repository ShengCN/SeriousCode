...
class Demo(ShowBase):
    ...
    def __init__(self):
        ...
        dirLight.setColor(Vec4(0.3, 0.9, 0.3, 1))
    ...
    def toggleRamp(self):
        ...
        if self.activeRamp == 0:
            ...
            self.render.setAttrib(LightRampAttrib.makeSingleThreshold(0.1, 0.3))
        elif self.activeRamp == 5:
            self.render.setAttrib(LightRampAttrib.makeDoubleThreshold(0, 0.1, 0.3, 0.8))
